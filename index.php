...
if (isset($_POST['submit'])) {
	// Validate name
	if (empty($_POST['name'])) {
		$nameErr = 'Name is required to post ';
	} else {
	...
	if (empty($_POST['email'])) {
		$emailErr = 'Email is required to post ';
	} else {
	...
	// Validate body
	if (empty($_POST['body'])) {
		$bodyErr = 'A message is required to post ';
	} else {
...
<h2>Feedback</h2>
<p class="lead text-center">Please leave feedback for me</p>
